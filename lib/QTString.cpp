...
{
	return str.erase(str.find_last_not_of(chars) + 1).erase(0, str.find_first_not_of(chars));
}

std::vector<std::string> QTString::vexplode (std::string delimiter, std::string _string, bool _trim)
{
	int _string_size;
